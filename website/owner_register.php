...
<div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-md fade-in">
    ...
    <form id="ownerSignup" class="space-y-4">
        ...
        <input type="submit" class="w-full bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg transition duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500" value="Register" />
    </form>
